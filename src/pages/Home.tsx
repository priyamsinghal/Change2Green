...
>
  ...
  {/* Card 1: 100% Recycled */}
  <div className="p-8 rounded-xl shadow-lg border border-gray-200 text-center text-white bg-gradient-to-br from-green-400 via-green-600 to-emerald-500">
  ...
  <div className="p-8 rounded-xl shadow-lg border border-gray-200 text-center text-white bg-gradient-to-br from-blue-400 via-sky-600 to-indigo-500">
    <div className="inline-flex items-center justify-center p-3 bg-white/20 rounded-full mb-6">
  ...
  <div className="p-8 rounded-xl shadow-lg border border-gray-200 text-center text-white bg-gradient-to-br from-yellow-400 via-orange-500 to-pink-500">
    <div className="inline-flex items-center justify-center p-3 bg-white/20 rounded-full mb-6">
